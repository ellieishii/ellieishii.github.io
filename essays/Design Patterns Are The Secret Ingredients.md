...
<img width="300px" class="rounded float-start pe-4" src="../img/cheesecake.jpg"> 
...
<img width="300px" class="rounded float-start" src="../img/baking.jpg"> <img width="300px" class="rounded float-start" src="../img/chiffoncake.jpg"> 
